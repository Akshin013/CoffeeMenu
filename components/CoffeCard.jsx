...
export default function CoffeeCard({ coffee, onAdd }) {
  return (
    <div className="bg-[#424141] rounded-2xl p-3 flex flex-col">
      {/* Image + Info в Link */}
      <Link href={`/det/${coffee.id}`} className="flex-1">
      ...
      <div className="flex items-center justify-between mt-3">
        <span className="text-white font-semibold">{coffee.price} ₼</span>
